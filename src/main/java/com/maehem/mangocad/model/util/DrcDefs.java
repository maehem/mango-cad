...
public enum DrcDefs {
    ...
    MT_COPPER("mtCopper", "0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm 0.0356mm"),
    MT_ISOLATE("mtIsolate", "1.5011mm 0.1499mm 0.2007mm 0.1499mm 0.2007mm 0.1499mm 0.2007mm 0.1499mm 0.2007mm 0.1499mm 0.2007mm 0.1499mm 0.2007mm 0.1499mm 0.2007mm"),
    ...
    MD_VIA2VIA_SAME_LAYER("mdViaViaSameLayer", "8mil"),
    MN_LAYERS2VIA_IN_SMD("mnLayersViaInSmd", "2"),
    MD_COPPER2DIMENSION("mdCopperDimension", "15mil"),
    MD_DRILL("mdDrill", "6mil"),
    MD_SMD2STOP("mdSmdStop", "0mil"),
    MS_WIDTH("msWidth", "6mil"),
    MS_DRILL("msDrill", "12mil"),
    MS_MICRO_VIA("msMicroVia", "13mil"),
    ...
    RL_MIN_PAD_TOP("rlMinPadTop", "7mil"),
    RL_MAX_PAD_TOP("rlMaxPadTop", "20mil"),
    RL_MIN_PAD_INNER("rlMinPadInner", "7mil"),
    RL_MAX_PAD_INNER("rlMaxPadInner", "20mil"),
    RL_MIN_PAD_BOTTOM("rlMinPadBottom ", "7mil"),
    RL_MAX_PAD_BOTTOM("rlMaxPadBottom ", "20mil"),
    RL_MIN_VIA_OUTER("rlMinViaOuter ", "7mil"),
    RL_MAX_VIA_OUTER("rlMaxViaOuter ", "20mil"),
    RL_MIN_VIA_INNER("rlMinViaInner ", "7mil"),
    ...
    ML_MIN_STOP_FRAME("mlMinStopFrame ", "3mil"),
    ML_MAX_STOP_FRAME("mlMaxStopFrame ", "3mil"),
    ML_MIN_CREAM_FRAME("mlMinCreamFrame ", "0mil"),
    ML_MAX_CREAM_FRAME("mlMaxCreamFrame ", "0mil"),
    ML_VIA_STOP_LIMIT("mlViaStopLimit ", "12mil"),
