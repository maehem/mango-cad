 ...
 */
public class EditableIntListWidgetTester extends Application implements ElementValueListener {

    private final ObservableList<Integer> options
            = FXCollections.observableArrayList(
                    1, 3, 5, 7, 11, 14, 18, 28, 222, 1000
            );
    ...
    public void start(Stage stage) throws Exception {
        configureLogging();
        LOGGER.log(Level.SEVERE, "MangoCAD Integer List Tester...");

        // Set the title of the Stage
        stage.setTitle("MangoCAD Integer List Tester");
    ...
    public void elementValueChanged(ElementValue newVal) {
        if (newVal.equals(valueProperty)) {
            sampleText.setText(String.valueOf(valueProperty.get()));
        }
    }
}
