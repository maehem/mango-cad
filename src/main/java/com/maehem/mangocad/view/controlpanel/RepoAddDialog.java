 ...
 */
public class RepoAddDialog extends Dialog<ButtonType> {

    public RepoAddDialog() {
        ...
        RepoAddPanel repoAddPanel = new RepoAddPanel();
        getDialogPane().setContent(repoAddPanel);
